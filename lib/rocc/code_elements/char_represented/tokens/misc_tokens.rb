...
module Rocc::CodeElements::CharRepresented::Tokens
  ...
  class Tkn1Char < CeCoToken
    ...
    def pursue_branch(compilation_context, branch)
      ...
      case @text
      when ';'
        semicolon_pursue(compilation_context, branch)
      when ','
        comma_pursue(compilation_context, branch)
      when '.'
        period_pursue(compilation_context, branch)
      when '{'
        brace_left_pursue(compilation_context, branch)
      when '}'
        brace_right_pursue(compilation_context, branch)
      when '('
        parentheses_left_pursue(compilation_context, branch)
      when ')'
        parentheses_right_pursue(compilation_context, branch)
      when '*'
        asterisk_pursue(compilation_context, branch)
      when '&'
        ampersand_pursue(compilation_context, branch)
      when '='
        equals_sign_pursue(compilation_context, branch)
      else
        super
      end # case @text
    ...
    def semicolon_pursue(compilation_context, branch)
    ...
    def comma_pursue(compilation_context, branch)
    ...
    def period_pursue(compilation_context, branch)
      if branch.has_pending?
    ...
    def brace_left_pursue(compilation_context, branch)
    ...
    def brace_right_pursue(compilation_context, branch)
      raise if branch.has_pending?
    ...
    def parentheses_left_pursue(compilation_context, branch)
      if branch.has_pending?
    ...
    def parentheses_right_pursue(compilation_context, branch)
    ...
    def asterisk_pursue(compilation_context, branch)
      case branch.current_scope
      when Rocc::Semantic::Temporary::ArisingSpecification
    ...
    def ampersand_pursue(compilation_context, branch)
      case branch.current_scope
    ...
    def equals_sign_pursue(compilation_context, branch)
      case branch.current_scope
      when Rocc::Semantic::Temporary::ArisingSpecification
