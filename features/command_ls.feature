...
#    | indented_hello_world/indented_hello_world_01.c                                 |
  ...
  Scenarios: minimal
    | code                                  | expect                                |
    | trivial/minimal/00_main.c             | trivial/minimal/00_main_ls_--spec     |
    | trivial/minimal/01_comment.c          | trivial/minimal/01_comment_ls_--spec  |
    | trivial/minimal/02_argc_argv.c        | trivial/minimal/02_argc_argv_ls_--spec|
    | trivial/minimal/03_global_var_decl.c  | trivial/minimal/03_global_var_decl_ls_--spec |
